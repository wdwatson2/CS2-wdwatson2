...
const int NRIDERS = 12, MAXFLOOR = 10; //10 floors including bottom floor zero
...
//        See what riders currently in the system are doing
        ...
        for (i=0;i<=lastrider;i++)
        {
            ...
            {
                if ((rider[i].floorfinish-rider[i].floorstart)*direction >= 0 || random(0,1) == 0)  //if the elevator is going in the direction the rider needs to go, stop and pick them up, or just do it half the time
                {
